...
<li>[urllib](https://docs.python.org/3.4/library/urllib.html?highlight=urllib#module-urllib) -网络库(stdlib)。
...
<li>[treq](https://github.com/dreid/treq) – 类似于requests的API（基于twisted）。
...
<li>[grab](http://docs.grablib.org/en/latest/#grab-spider-user-manual) – 网络爬虫框架（基于pycurl/multicur）。
...
<li>[portia](https://github.com/scrapinghub/portia) – 基于Scrapy的可视化爬虫。
...
<li>[lxml](http://lxml.de/) – C语言编写高效HTML/ XML处理库。支持XPath。
...
<li>[Bleach](http://bleach.readthedocs.org/en/latest/) – 清理HTML（需要html5lib）。
...
<li>[furl](https://github.com/gruns/furl) – 一个小的Python库，使得操纵URL简单化。
...
<li>[netaddr](https://github.com/drkjam/netaddr) – 用于显示和操纵网络地址的Python库。
...
<li>[newspaper](https://github.com/codelucas/newspaper) – 用Python进行新闻提取、文章提取和内容策展。
...
<li>[youtube-dl](http://rg3.github.io/youtube-dl/) – 一个从YouTube下载视频的小命令行程序。
...
<li>[WikiTeam](https://github.com/WikiTeam/wikiteam) – 下载和保存wikis的工具。
...
英文原文地址：[https://github.com/lorien/awesome-web-scraping/blob/master/python.md](https://github.com/lorien/awesome-web-scraping/blob/master/python.md)

中文翻译原文地址：[http://python.jobbole.com/82633/ ](http://python.jobbole.com/82633/)
